 ...
 */
	Configure::write('Security.salt', 'IaretOAwcxEfsfdghdFOZO098098fqdfQ90qfs89DQSF0qojpskd');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '234567898765432347989698317583749082375');
